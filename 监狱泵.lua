...
local Lang = {
    ...
    [SupportedLanguages.English] = {
        LoadingTitle = "SB HUB Prison pump",
...
local function LoadMainScript(lang)
    ...
    local Window = Rayfield:CreateWindow({
        ...
        ConfigurationSaving = {
            Enabled = true,
            FolderName = "SB_HUB_Config_Prison",
            FileName = "Settings"
        }
    })
    ...
    local PrisonTab = Window:CreateTab(texts.PrisonTab, "user")
    PrisonTab:CreateButton({
        Name = texts.InfiniteStamina,
        Callback = function()
